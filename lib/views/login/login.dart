...
class _LoginState extends State<Login> {
                      ...
                      onPressed: () async {
                        ...
                        if (submitSt) {
                          AppNavigator.pushReplace(
                              context: context, page: const Landing());
                        }
                      },
                      child: FadeInLeft(
                          from: 10,
                      ...
                      onValidate: (value) {
                        ...
                        if (value.isEmpty) {
                          return AppLocalizations.of(context)!
                              .translate('email_or_phone_empty_validate');
                        }
                          ...
                          TextButton(
                              onPressed: () async {
                                await Future.delayed(
                                    const Duration(milliseconds: 250));
                                AppNavigator.push(
                                    context: context, page: const ForgetPass());
                              },
                              child: Padding(
  ...
  void submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        dynamic result =
            await Provider.of<InitViewModel>(context, listen: false).login(
                context,
