...
class _AppTextFieldState extends State<AppTextField> {
    ...
    return Container(
      ...
      child: Directionality(
        ...
        child: TextFormField(
          ...
          style: TextStyle(
              fontSize: 17,
              color: widget.isEnable != null && widget.isEnable == false
                  ? Colors.grey[400]
                  : Colors.grey[700]),
          ...
          obscureText: widget.isPassword != null
              ? (widget.toggleVisibleSt != null &&
                      widget.toggleVisibleSt == true
          ...
          decoration: InputDecoration(
            ...
            border: widget.hasBorder != null && widget.hasBorder!
                ...
                : InputBorder.none,
            focusedBorder: widget.hasBorder != null && widget.hasBorder!
                ? OutlineInputBorder(
                    borderSide: BorderSide(
                        color: widget.borderColor != null
                            ? widget.borderColor!
                    ...
                    borderRadius: BorderRadius.all(
                        Radius.circular(widget.borderRadius ?? 30)))
                : InputBorder.none,
            enabledBorder: widget.hasBorder != null && widget.hasBorder!
                ? OutlineInputBorder(
                    borderSide: BorderSide(
                        color: widget.borderColor != null
                            ? widget.borderColor!
            ...
            errorBorder: OutlineInputBorder(
                ...
                borderRadius: BorderRadius.all(
                    Radius.circular(widget.borderRadius ?? 30))),
            disabledBorder: widget.hasBorder != null && widget.hasBorder!
                ? OutlineInputBorder(
                    borderSide: BorderSide(
                        color: widget.borderColor != null
                            ? widget.borderColor!
            ...
            suffixIcon: widget.suffixIcon != null
                ? Container(
                    ...
                    width: widget.toggleVisibleSt != null &&
                            widget.toggleVisibleSt == true
                        ? 120
                        : 82,
                    child: Row(
  ...
  Widget removeButton() {
    return widget.isEnable != null && widget.isEnable! == false
        ? Container(width: 0)
        : GestureDetector(
            onTap: () {
              controller!.clear();
            ...
            child: Icon(Icons.cancel, size: 21, color: Colors.grey[400]));
  }
